...
from tools import write_conf, read_conf, test_connect, result, jisuan
...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.pushButton_8.clicked.connect(self.jisua)
    ...
    def jisua(self):
        self.ji = jisuan.Js()
        self.ji.start()
        self.ji.myOut.connect(self.setplot)
    ...
    def readconf(self):
        directory1, filetype = QFileDialog.getOpenFileName(self,
                                                           ...
                                                           "./config/",
                                                           "Setting Files (*.ini)")
        self.rd = read_conf.MyTh('svswr', directory1)
        self.rd.myOut.connect(self.set_text)
        self.rd.start()
        self.statusBar.showMessage('从本地读取配置成功', 10 ** 4)
