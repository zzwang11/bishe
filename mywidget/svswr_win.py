...
第二步，半波暗室的地面上铺上吸波材料，将矢网的port1和Tx电缆连接，将矢网的port2端口和Rx电缆连接。
第三步，将偶极天线放置在1m高的平台中心，使其极化为水平，连接到Tx电缆。
在3m外放置喇叭天线，接Rx电缆。与偶极天线保持同样的高度，保证2个天线正对，
且都为水平极化。读取矢网1-18GHz的数值。随后依次将偶极天线向远离喇叭天线的
方向移动2厘米、10厘米、18厘米、30厘米、40厘米。读取矢网，一共得到6组数值。
第四步，将偶极天线放置在平台的最前位置，随后依次将偶极天线向远离喇叭
天线的方向移动2厘米、10厘米、18厘米、30厘米、40厘米。读取矢网，一共得到6组数值。
第五步，将偶极天线放置在平台的最左位置，随后依次将偶极天线向靠近喇叭
天线的方向移动2厘米、10厘米、18厘米、30厘米、40厘米。读取矢网，一共得到6组数值。
第六步，将偶极天线放置在平台的最前位置，随后依次将偶极天线向靠近喇叭
天线的方向移动2厘米、10厘米、18厘米、30厘米、40厘米。读取矢网，一共得到6组数值。
第七步，将偶极天线放置在平台的最中心位置，随后将偶极天线和喇叭天线都
升至2m高度。随后依次将偶极天线向远离喇叭天线的方向移动2厘米、10厘米、18厘米
、30厘米、40厘米。读取矢网，一共得到6组数值。
第八步，把天线变为垂直极化重复上边的第三步—第七步。
第九步，将每个频点的测量最大分贝值减去最小分贝值就是最终的结果。
...
''')
        ...
        jpg = QtGui.QPixmap('e:/bishe/img/svswr.jpg').scaled(650, 370)
        ...
        self.qtext1.setText('''第一步，进行校准，见章节4.1.4.
第二步，半波暗室的地面上铺上吸波材料，将矢网的port1和Tx电缆连接，将矢网的port2端口和Rx电缆连接。
第三步，将偶极天线放置在1m高的平台中心，使其极化为水平，连接到Tx电缆。
在3m外放置喇叭天线，接Rx电缆。与偶极天线保持同样的高度，保证2个天线正对，
且都为水平极化。读取矢网1-18GHz的数值。随后依次将偶极天线向远离喇叭天线的
...
第九步，将每个频点的测量最大分贝值减去最小分贝值就是最终的结果。
        ...
        jpg1 = QtGui.QPixmap('e:/bishe/img/zhijie.jpg').scaled(700, 370)
...
#         self.widget6.hide()
    ...
    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "电压驻波比测试"))
        self.pushButton_8.setText(_translate("MainWindow", "读取结果"))
